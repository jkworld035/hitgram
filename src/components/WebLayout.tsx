...
const navItems = [
  ...
  { href:'/jarvis', label:'IRA Voice AI', icon:<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v4M12 19v4M4.22 4.22l2.83 2.83M16.95 16.95l2.83 2.83M1 12h4M19 12h4M4.22 19.78l2.83-2.83M16.95 7.05l2.83-2.83"/></svg>, badge:'AI' },
        ...
        <div>
          ...
          <div style={{ display:'flex', flexDirection:'column', gap:'6px' }}>
            {[
              ...
              {href:'/jarvis', label:'Talk to IRA', icon:'◎', color:'#AAFF00'},
